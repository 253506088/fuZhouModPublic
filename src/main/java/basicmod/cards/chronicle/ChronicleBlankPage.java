...
public class ChronicleBlankPage extends BaseCard {
    public static final String ID = makeID(ChronicleBlankPage.class.getSimpleName());
    ...
    public ChronicleBlankPage() { super(ID, stats); setMagic(1, 1); }
