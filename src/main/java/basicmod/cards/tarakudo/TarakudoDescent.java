...
public class TarakudoDescent extends BaseCard {
    public static final String ID = makeID(TarakudoDescent.class.getSimpleName());
    ...
    public TarakudoDescent() { super(ID, stats); setMagic(3, 1); }
