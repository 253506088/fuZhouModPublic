...
public class NineMaskRotation extends BaseCard {
    public static final String ID = makeID(NineMaskRotation.class.getSimpleName());
    ...
    public NineMaskRotation() { super(ID, stats); setMagic(1, 1); }
