...
public class UncleBanishEvil extends BaseCard {
    public static final String ID = makeID(UncleBanishEvil.class.getSimpleName());
    ...
    public UncleBanishEvil() { super(ID, stats); setBlock(5, 3); setExhaust(true); }
