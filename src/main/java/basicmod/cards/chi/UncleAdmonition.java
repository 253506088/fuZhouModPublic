...
public class UncleAdmonition extends BaseCard {
    public static final String ID = makeID(UncleAdmonition.class.getSimpleName());
    ...
    public UncleAdmonition() { super(ID, stats); setMagic(1, 1); }
