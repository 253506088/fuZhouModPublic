...
public class EightGatesSealed extends BaseCard {
    public static final String ID = makeID(EightGatesSealed.class.getSimpleName());
    ...
    public EightGatesSealed() { super(ID, stats); setMagic(2, 1); }
