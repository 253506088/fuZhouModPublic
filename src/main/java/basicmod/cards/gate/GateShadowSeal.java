...
public class GateShadowSeal extends BaseCard {
    public static final String ID = makeID(GateShadowSeal.class.getSimpleName());
    ...
    public GateShadowSeal() { super(ID, stats); setMagic(3, 2); }
