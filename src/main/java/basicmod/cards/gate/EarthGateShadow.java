...
public class EarthGateShadow extends BaseCard {
    public static final String ID = makeID(EarthGateShadow.class.getSimpleName());
    ...
    public EarthGateShadow() { super(ID, stats); setDamage(6, 2); setMagic(1, 1); }
