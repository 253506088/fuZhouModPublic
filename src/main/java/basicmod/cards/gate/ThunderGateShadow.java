...
public class ThunderGateShadow extends BaseCard {
    public static final String ID = makeID(ThunderGateShadow.class.getSimpleName());
    ...
    public ThunderGateShadow() { super(ID, stats); setDamage(3, 2); setMagic(1, 1); }
