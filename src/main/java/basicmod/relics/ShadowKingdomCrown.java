...
public class ShadowKingdomCrown extends BaseRelic {
    public static final String NAME = "ShadowKingdomCrown";
    public static final String ID = makeID(NAME);
    private static final RelicTier RARITY = RelicTier.RARE;
    private static final LandingSound SOUND = LandingSound.MAGICAL;
    public ShadowKingdomCrown() { super(ID, NAME, CharacterEnums.SHENGZHU_COLOR, RARITY, SOUND); }
