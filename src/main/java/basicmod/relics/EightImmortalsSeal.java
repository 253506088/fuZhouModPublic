...
public class EightImmortalsSeal extends BaseRelic {
    public static final String NAME = "EightImmortalsSeal";
    public static final String ID = makeID(NAME);
    private static final RelicTier RARITY = RelicTier.RARE;
    private static final LandingSound SOUND = LandingSound.MAGICAL;
    public EightImmortalsSeal() { super(ID, NAME, CharacterEnums.SHENGZHU_COLOR, RARITY, SOUND); }
