...
public class BurningHeartPower extends BasePower {
    public static final String POWER_ID = BasicMod.makeID("BurningHeartPower");
    ...
    public BurningHeartPower(AbstractCreature owner, AbstractCreature source, int amount) {
