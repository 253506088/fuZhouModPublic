...
public class FrostbitePower extends BasePower {
    public static final String POWER_ID = BasicMod.makeID("FrostbitePower");
    ...
    private void checkEvolution() {
        if (this.amount >= 9) {
            ...
            // 转化为 3 层 冰狱
            int hellAmount = evolveCount * 3;
            
            this.amount = remaining;
            com.megacrit.cardcrawl.dungeons.AbstractDungeon.actionManager.addToTop(new com.megacrit.cardcrawl.actions.common.ApplyPowerAction(this.owner, this.source, new FrostHellPower(this.owner, this.source, hellAmount), hellAmount));
